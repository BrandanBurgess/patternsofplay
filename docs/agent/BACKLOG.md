...
| T-112 | Counterpress ring, currently unrendered so the Rondo Map ships 5 of the 6 zones doc 06 section 0 approved. Needs canonical_rondo/zone_kind/radius added to RondoZoneOut and the formations.py mapping, a place-the-ball affordance on the Formations page, and the ring drawn as a circle. Then delete the splitRondoName ratio workaround in formationsLab.ts | 0, 2.3, 5.1 | screens | opus | T-106 | T-107 | blocked: founder decision |
