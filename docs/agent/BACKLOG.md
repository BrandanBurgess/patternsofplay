...
| T-112 | Counterpress ring, currently unrendered so the Rondo Map ships 5 of the 6 zones doc 06 section 0 approved. Doc 06 section 2.3 already specifies the no-ball fallback (centroid of our three most advanced), which T-106 never saw because its row named only 5.1/5.2/5.4. Add canonical_rondo/zone_kind/radius to RondoZoneOut and the formations.py mapping, draw the ring as a circle, delete the splitRondoName ratio workaround | 0, 2.3, 5.1 | screens | opus | T-106 | T-107 | todo |
